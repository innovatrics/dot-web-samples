...
declare module "document-auto-capture/src/utils/rectangles" {
    ...
    export function getOutOfBoundsValidatorRectangle(camera: Resolution, outOfBoundsThreshold: number): {
        shiftX: number;
        shiftY: number;
        width: number;
        height: number;
    ...
    export function detectionPercentToImagePercent(camera: Resolution, detectionPercent: Point): Point;
    export function detectionDocumentCornersToImagePercent(camera: Resolution, detectedDocument: DetectedDocument): DetectedDocument;
    export function detectionDocumentCornersToDetectionPercent(camera: Resolution, detectedDocument: DetectedDocument): DetectedDocument;
    export function imagePercentRectangleToDetectionPercent(camera: Resolution, rectangle: Crop): Crop;
    function rectangles(camera: Resolution, imagePercent: Point): RectangleConvertFunctions;
...
declare module "document-auto-capture/src/context/CameraOptionsProvider" {
    ...
    import { InitializedDocumentCameraProps, DocumentCameraProps } from "common/types";
    interface Props {
...
declare module "document-auto-capture/src/utils/documentDetector" {
    ...
    class DocumentDetector {
        ...
        detectDocument(detectionImage: HTMLCanvasElement, placeholderImage: HTMLCanvasElement): Promise<ParsedDetectedDocument>;
    }
...
declare module "document-auto-capture/src/utils/validators" {
    import { DetectedDocument, ParsedDetectedDocument, Resolution } from "common/types";
    export const addCustomValidationValues: (document: ParsedDetectedDocument, cameraResolution: Resolution, detectionImage: Resolution) => DetectedDocument;
    export const getDocumentSmallestEdge: (document: ParsedDetectedDocument, detectionImage: Resolution) => number;
    export const isNotOutOfBoundsValidator: (OUT_OF_BOUNDS_THRESHOLD: number, document: DetectedDocument) => boolean;
}
declare module "document-auto-capture/src/utils/Controller" {
    import { DocumentThresholds, DetectedDocument, DocumentInstructionCode, DocumentValidationMode } from "common/types";
    type DocumentChecks = {
        isPresent: boolean;
        doesFit: boolean;
    ...
    class DocumentController {
        ...
        constructor(customThresholds: Required<DocumentThresholds>, validationMode: DocumentValidationMode);
        initDocumentDetector(samWasmUrl?: string): Promise<void>;
        getBestImage(): BestImageCandidate | null;
        isNewImageBetter(oldDocument: DetectedDocument, newDocument: DetectedDocument): boolean;
        ...
        getInstructionCode: (checks: DocumentChecks, isDetectedDocumentValid: boolean) => DocumentInstructionCode;
...
declare module "document-auto-capture/src/components/wrappers/DocumentInitialization" {
    ...
    const DocumentInitialization: ({ cameraOptions }: DocumentInitializationProps) => h.JSX.Element | null;
