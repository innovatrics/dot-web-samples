$(function(){
  $('#selfie').click(function (e){
    ...
    $('#container').empty() // remove any potential existing components
  ...
  $('#document').click(function (e){ // same as face component above, we need to make sure we're workign with a fresh copy before supplying it with props
    e.preventDefault();
