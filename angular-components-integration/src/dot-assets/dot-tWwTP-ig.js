...
var H = (a, o, e) => (Nt(a, o, "read from private field"), e ? e.call(a) : o.get(a)), Wn = (a, o, e) => o.has(a) ? jt("Cannot add the same private member more than once") : o instanceof WeakSet ? o.add(a) : o.set(a, e), kn = (a, o, e, y) => (Nt(a, o, "write to private field"), y ? y.call(a, e) : o.set(a, e), e);
const Ht = {
  simd: "sam_simd.wasm",
  sam: "sam.wasm"
...
var we = function() {
  ...
  return function(o) {
    ...
    var b = "./this.program", O = !1, E = !1;
    O = typeof window == "object", E = typeof importScripts == "function";
    var _ = "", R;
    (O || E) && (E ? _ = self.location.href : document.currentScript && (_ = document.currentScript.src), a && (_ = a), _.indexOf("blob:") !== 0 ? _ = _.substr(0, _.lastIndexOf("/") + 1) : _ = "", E && (R = function(n) {
    ...
    var nn, Z, I, tn, gn, S, U, ot, st;
    function ut(n) {
      nn = n, e.HEAP8 = Z = new Int8Array(n), e.HEAP16 = tn = new Int16Array(n), e.HEAP32 = S = new Int32Array(n), e.HEAPU8 = I = new Uint8Array(n), e.HEAPU16 = gn = new Uint16Array(n), e.HEAPU32 = U = new Uint32Array(n), e.HEAPF32 = ot = new Float32Array(n), e.HEAPF64 = st = new Float64Array(n);
    }
    ...
    if (!ht()) {
      var pt = K;
      K = e.locateFile ? e.locateFile(pt, _) : _ + pt;
    }
    function mt() {
      try {
    ...
    function ee() {
      return L || !O && !E || typeof fetch != "function" || Hn("file://") ? Promise.resolve().then(mt) : fetch(K, { credentials: "same-origin" }).then(function(n) {
...
` + i.replace(/^Error(:[^\n]*)?\n/, ""));
    ...
    function an(n, t, r) {
      function i(l) {
        ...
        for (var p = 0; p < n.length; ++p) z(n[p], l[p]);
      }
      ...
      t.forEach(function(l, p) {
        Q.hasOwnProperty(l) ? s[p] = Q[l] : (u.push(l), en.hasOwnProperty(l) || (en[l] = []), en[l].push(function() {
          s[p] = Q[l], ++c, c === u.length && i(s);
        }));
      }), u.length === 0 && i(s);
    }
    function z(n, t, r) {
    ...
    function bt(n, t) {
      for (var r = [], i = 0; i < n; i++) r.push(S[(t >> 2) + i]);
      return r;
    }
    function bn(n) {
      for (; n.length; ) {
    ...
    for (var It = Array(256), On = 0; 256 > On; ++On) It[On] = String.fromCharCode(On);
    yt = It, rn = e.BindingError = Vn("BindingError"), vt = e.InternalError = Vn("InternalError"), V.prototype.isAliasOf = function(n) {
      ...
      return this.A.da || Gn(this), this.A.oa && !this.A.pa && v("Object already scheduled for deletion"), pn.push(this), pn.length === 1 && hn && hn(Yn), this.A.oa = !0, this;
      ...
      var n = [], t;
      for (t in mn) mn.hasOwnProperty(t) && n.push(mn[t]);
      return n;
    }, e.flushPendingDeletes = Yn, e.setDelayFunction = function(n) {
      hn = n, pn.length && hn && hn(Yn);
    ...
    var me = {
      ...
      w: function(n, t, r, i, s) {
        var u = zn(r);
        t = W(t), z(n, { name: t, fromWireType: function(c) {
          return !!c;
      ...
      h: function(n, t, r, i, s, u, c, l, p, f, d, h, w) {
        d = W(d), u = G(s, u), l && (l = G(c, l)), f && (f = G(p, f)), w = G(h, w);
        var T = Bn(d);
        _t(T, function() {
          yn("Cannot construct " + d + " due to unbound types", [i]);
        }), an([n, t, r], i ? [i] : [], function(m) {
          if (m = m[0], i)
            var N = m.ea, M = N.ma;
          else M = V.prototype;
          m = Dn(T, function() {
          ...
          var k = Object.create(M, { constructor: { value: m } });
          m.prototype = k;
          var j = new oe(d, m, k, w, N, u, l, f);
          N = new B(d, j, !0, !1), M = new B(d + "*", j, !1, !1);
          var vn = new B(d + " const*", j, !1, !0);
          return At[n] = { pointerType: M, za: vn }, Et(T, m), [N, M, vn];
        });
      },
      g: function(n, t, r, i, s, u) {
        ...
        an([], [n], function(f) {
          ...
          return f.ea.la[t - 1] = function() {
            ...
            return f.ea.la[t - 1] = function() {
              arguments.length !== t - 1 && v(d + " called with " + arguments.length + " arguments, expected " + (t - 1)), p.length = 0, l.length = t;
              for (var w = 1; w < t; ++w) l[w] = h[w].toWireType(
                p,
                arguments[w - 1]
              );
              return w = s.apply(null, l), bn(p), h[0].fromWireType(w);
            }, [];
          }), [];
        });
      },
      b: function(n, t, r, i, s, u, c, l, p, f) {
        t = W(t), s = G(i, s), an([], [n], function(d) {
          d = d[0];
          var h = d.name + "." + t, w = { get: function() {
            yn("Cannot access " + h + " due to unbound types", [r, c]);
          }, enumerable: !0, configurable: !0 };
          return p ? w.set = function() {
            yn("Cannot access " + h + " due to unbound types", [r, c]);
          } : w.set = function() {
            v(h + " is a read-only property");
          }, Object.defineProperty(d.ea.ma, t, w), an([], p ? [r, c] : [r], function(T) {
            var m = T[0], N = { get: function() {
              var k = Ot(this, d, h + " getter");
              return m.fromWireType(s(u, k));
            }, enumerable: !0 };
            if (p) {
              p = G(l, p);
              var M = T[1];
              N.set = function(k) {
                var j = Ot(this, d, h + " setter"), vn = [];
                p(f, j, M.toWireType(vn, k)), bn(vn);
              };
            }
      ...
      v: function(n, t) {
        t = W(t), z(n, { name: t, fromWireType: function(r) {
          var i = x[r].value;
          return Jn(r), i;
      ...
      c: function(n, t, r, i, s, u) {
        ...
        n = W(n), s = G(i, s), _t(n, function() {
          ...
          for (var w = l[1] !== null && !1, T = !1, m = 1; m < l.length; ++m) if (l[m] !== null && l[m].ka === void 0) {
            T = !0;
            break;
          }
          var N = l[0].name !== "void", M = "", k = "";
          for (m = 0; m < h - 2; ++m) M += (m !== 0 ? ", " : "") + "arg" + m, k += (m !== 0 ? ", " : "") + "arg" + m + "Wired";
          f = "return function " + Bn(f) + "(" + M + `) {
...
`);
          ...
          for (M = "throwBindingError invoker fn runDestructors retType classParam".split(" "), d = [v, d, u, bn, l[0], l[1]], w && (f += "var thisWired = classParam.toWireType(" + j + `, this);
`), m = 0; m < h - 2; ++m) f += "var arg" + m + "Wired = argType" + m + ".toWireType(" + j + ", arg" + m + "); // " + l[m + 2].name + `
`, M.push("argType" + m), d.push(l[m + 2]);
          if (w && (k = "thisWired" + (0 < k.length ? ", " : "") + k), f += (N ? "var rv = " : "") + "invoker(fn" + (0 < k.length ? ", " : "") + k + `);
`, T) f += `runDestructors(destructors);
`;
          else for (m = w ? 1 : 2; m < l.length; ++m) h = m === 1 ? "thisWired" : "arg" + (m - 2) + "Wired", l[m].ka !== null && (f += h + "_dtor(" + h + "); // " + l[m].name + `
`, M.push(h + "_dtor"), d.push(l[m].ka));
          return N && (f += `var ret = retType.fromWireType(rv);
return ret;
`), M.push(f + `}
`), l = de(M).apply(null, d), Et(p, l, t - 1), [];
        });
      },
      ...
      d: function(n, t, r) {
        ...
        r = W(r), z(n, { name: r, fromWireType: i, argPackAdvance: 8, readValueFromPointer: i }, { Ea: !0 });
      },
      n: function(n, t) {
        t = W(t);
        var r = t === "std::string";
        z(n, {
            ...
            if (r) for (var u = i + 4, c = 0; c <= s; ++c) {
              ...
              if (c == s || I[l] == 0) {
                if (u) {
                  var p = u, f = I, d = p + (l - u);
                  for (u = p; f[u] && !(u >= d); ) ++u;
                  if (16 < u - p && f.subarray && it) p = it.decode(f.subarray(p, u));
                  else {
                    for (d = ""; p < u; ) {
                      var h = f[p++];
                      if (h & 128) {
                        ...
                        if ((h & 224) == 192) d += String.fromCharCode((h & 31) << 6 | w);
                          ...
                          var T = f[p++] & 63;
                          h = (h & 240) == 224 ? (h & 15) << 12 | w << 6 | T : (h & 7) << 18 | w << 12 | T << 6 | f[p++] & 63, 65536 > h ? d += String.fromCharCode(h) : (h -= 65536, d += String.fromCharCode(55296 | h >> 10, 56320 | h & 1023));
                        }
              ...
              for (m = Array(s), c = 0; c < s; ++c) m[c] = String.fromCharCode(I[i + 4 + c]);
              m = m.join("");
            }
            return D(i), m;
          },
          toWireType: function(i, s) {
            ...
            if (U[l >> 2] = c, r && u) Yt(s, l + 4, c + 1);
              ...
              255 < p && (D(l), v("String has UTF-16 code units that do not fit in 8 bits")), I[l + 4 + u] = p;
            }
      ...
      j: function(n, t, r) {
        ...
        z(n, { name: r, fromWireType: function(p) {
          for (var f = U[p >> 2], d = c(), h, w = p + 4, T = 0; T <= f; ++T) {
            var m = p + 4 + T * t;
            (T == f || d[m >> l] == 0) && (w = i(w, m - w), h === void 0 ? h = w : (h += "\0", h += w), w = m + t);
          }
          return D(p), h;
        }, toWireType: function(p, f) {
          typeof f != "string" && v("Cannot pass non-string to C++ string type " + r);
          var d = u(f), h = Mn(4 + d + t);
          return U[h >> 2] = d >> l, s(f, h + 4, d + t), p !== null && p.push(D, h), h;
        }, argPackAdvance: 8, readValueFromPointer: Tn, ka: function(p) {
          D(p);
        } });
      },
      x: function(n, t) {
        t = W(t), z(n, { Qa: !0, name: t, argPackAdvance: 0, fromWireType: function() {
        }, toWireType: function() {
        } });
      },
      k: function(n, t, r) {
        n = Kn(n), t = Mt(t, "emval::as");
        var i = [], s = on(i);
        return S[r >> 2] = s, t.toWireType(i, n);
      },
      i: Jn,
      l: function(n, t) {
      ...
      p: function(n) {
        var t = pe[n];
        return on(t === void 0 ? W(n) : t);
      },
      o: function(n) {
        bn(x[n].value), Jn(n);
      },
      y: function(n, t) {
        return n = Mt(n, "_emval_take_value"), n = n.readValueFromPointer(t), on(n);
      },
      f: function() {
        fn();
      },
      ...
      s: function(n, t) {
        var r = 0;
        return Wt().forEach(function(i, s) {
          var u = t + r;
          for (s = S[n + 4 * s >> 2] = u, u = 0; u < i.length; ++u) Z[s++ >> 0] = i.charCodeAt(u);
    ...
    var xt = e.___wasm_call_ctors = function() {
      ...
      return (Mn = e._malloc = e.asm.C).apply(null, arguments);
    }, D = e._free = function() {
...
class Ce {
  ...
  async getWasmFileName() {
    return await ge() ? Ht.simd : Ht.sam;
  }
  async initSamModule(o, e) {
    if (this.samWasmModule)
      return;
    const y = await this.getWasmFileName(), g = `${e}/wasm/${y}`;
    try {
      this.samWasmModule = await we(this.getOverriddenModules(o, g));
    } catch {
  ...
  writeImageToMemory(o) {
    ...
    const e = new _e(this.samWasmModule, o);
...
const Rn = (a, o) => Math.hypot(o.x - a.x, o.y - a.y), Ee = (a) => {
  const { bottomLeft: o, bottomRight: e, topLeft: y, topRight: g } = a, C = Rn(y, g), A = Rn(g, e), b = Rn(o, e), O = Rn(y, o);
  return Math.min(C, A, b, O);
};
/**
 * @license
 ...
 */
const zt = Symbol("Comlink.proxy"), Te = Symbol("Comlink.endpoint"), Pe = Symbol("Comlink.releaseProxy"), nt = Symbol("Comlink.finalizer"), xn = Symbol("Comlink.thrown"), Bt = (a) => typeof a == "object" && a !== null || typeof a == "function", be = {
...
function et(a, o = globalThis, e = ["*"]) {
  o.addEventListener("message", function y(g) {
    ...
    const { id: C, type: A, path: b } = Object.assign({ path: [] }, g.data), O = (g.data.argumentList || []).map(X);
    let E;
    try {
...
function Ut(a) {
  const o = a.map(jn);
  return [o.map((e) => e[0]), Ie(o.map((e) => e[1]))];
}
