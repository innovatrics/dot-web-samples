...
import type { HTMLMagnifEyeLivenessElement, MagnifEyeLivenessConfiguration } from '@innovatrics/dot-magnifeye-liveness';
...
function MagnifEyeLivenessCamera(configuration: MagnifEyeLivenessConfiguration) {
  useEffect(() => {
    ...
    if (magnifEyeLivenessHTMLElement) {
      magnifEyeLivenessHTMLElement.configuration = configuration;
    }
  });
